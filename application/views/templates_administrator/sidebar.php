        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('administrator/matapelajaran') ?>">Mata Pelajaran</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/inputnilai') ?>">Input Nilai</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/nilai') ?>">Hasil Belajar</a>
                        <!-- <a class="collapse-item" href="<?php echo base_url('administrator/transkrip') ?>">Cetak Transkip</a> -->
                        <a class="collapse-item" href="<?php echo base_url('administrator/semester') ?>">Semester</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/tahunajaran') ?>">Tahun Ajaran</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Sub-Menu Info SekolahK:</h6>
                        <a class="collapse-item" href="<?php echo base_url('administrator/pengumuman') ?>">Pengumuman</a>
