                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="<?php echo base_url('guru/auth/proses_login') ?>" class="user mb-2">
                                    ...
                                    <a href="<?= base_url() . 'ortu/auth' ?>">Login sebagai Orangtua |</a>
                                    <a href="<?= base_url() . 'siswa/auth' ?>"> Login sebagai Siswa</a>
                                </div>
                            </div>
                        </div>
                    </div>
