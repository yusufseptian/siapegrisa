...
class Nilai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('guru/masuk_hasil_belajar', $data);
    ...
    public function nilai_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('guru/templates/header');
            $this->load->view('guru/templates/sidebar');
            $this->load->view('guru/hasil_belajar', $data);
            $this->load->view('guru/templates/footer');
        }
    }
    ...
    public function print($nis, $id_semester)
    {
        ...
        $query_nilai = "SELECT nilai.kkm, nilai.nilai, matapelajaran.kode_matapelajaran, matapelajaran.nama_matapelajaran
                FROM nilai
                JOIN matapelajaran ON (nilai.kode_matapelajaran = matapelajaran.kode_matapelajaran)
                JOIN semester ON (matapelajaran.id_semester = semester.id_semester)
                WHERE nilai.nis_siswa = $nis AND semester.id_semester = $id_semester";
