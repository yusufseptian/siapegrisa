...
class inputnilai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('administrator/masuk_inputnilai_form', $data);
    ...
    public function form_masuk_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates_administrator/header');
            $this->load->view('templates_administrator/sidebar');
            $this->load->view('administrator/inputnilai', $data);
            $this->load->view('templates_administrator/footer');
    ...
    public function inputNilai($nis, $kode_mp)
    {
        ...
        $this->load->view('templates_administrator/header');
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/inputnilai_form', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_administrator/header');
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/inputnilai_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    public function setKkm($id)
    {
        ...
        $this->load->view('templates_administrator/header');
        $this->load->view('templates_administrator/sidebar');
        $this->load->view('administrator/kkm_update', $data);
        $this->load->view('templates_administrator/footer');
    }
    ...
    public function delete($id)
    {
        ...
        redirect('administrator/inputnilai');
    }
}
